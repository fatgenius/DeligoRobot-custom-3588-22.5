...
public class EasyDialog extends Dialog implements View.OnClickListener {
    ...
    public void fourChoice(String content, String oneBtnText, String twoBtnText, String threeBtnText, String fourBtnText, OnViewClickListener onViewClickListener) {
        try {
            Button btnOne = root.findViewById(R.id.btn_one);
            Button btnTwo = root.findViewById(R.id.btn_two);
            Button btnThree = root.findViewById(R.id.btn_three);
            Button btnFour = root.findViewById(R.id.btn_four);
            ...
            btnOne.setText(oneBtnText);
            btnTwo.setText(twoBtnText);
            btnThree.setText(threeBtnText);
            btnFour.setText(fourBtnText);
            tvContent.setText(content);
    ...
    public void emergencyStopOn() {
        try {
            Button btnISee = root.findViewById(R.id.btn_i_see);
            btnISee.setOnClickListener(v -> dismiss());
            Window window = getWindow();
