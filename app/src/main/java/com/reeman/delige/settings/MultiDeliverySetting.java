...
public class MultiDeliverySetting extends BaseSetting {
    ...
    public MultiDeliverySetting(float runningSpeed, int pauseTime, boolean enableBackgroundMusic, String backgroundMusicFileName, String backgroundMusicPath, boolean enableDeliveryArrivalPrompt, List<Integer> targetPromptForDeliveryArrival, List<String> deliveryArrivalPrompts, List<String> deliveryArrivalPromptAudioList) {
    ...
    public static MultiDeliverySetting getDefault() {
        return new MultiDeliverySetting(0.4f, 30, false, null, null, true, new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
    }

    @Override
    public String toString() {
        return "MultiDeliverySetting{" +
